...
parser.add_argument("--index_path", type=str, default=f"{RETRIEVER_PATH}/database/wikipedia/bm25", help="Corpus indexing file.")
parser.add_argument("--corpus_path", type=str, default=f"{RETRIEVER_PATH}/database/wikipedia/wiki-18.jsonl", help="Local corpus file.")
